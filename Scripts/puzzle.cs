...
public class puzzle : MonoBehaviour
{
    ...
    void Update()
    {
        rayCheck interfereObj = gameObject.GetComponent<rayCheck>();

        if (Input.GetKeyDown(KeyCode.E) && inBounds && back == false && completed == false && interfereObj.interfere)
        {
        ...
        else if (Input.GetKeyDown(KeyCode.E) && inBounds && back == false && completed == false && interfereObj.interfere == false)
        {
